...
class LoginRegisterationWidget extends StatefulWidget {
  const LoginRegisterationWidget({Key key}) : super(key: key);

  @override
  _LoginRegisterationWidgetState createState() =>
      _LoginRegisterationWidgetState();
}

class _LoginRegisterationWidgetState extends State<LoginRegisterationWidget> {
